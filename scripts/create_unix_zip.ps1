# Create Unix-compatible ZIP for Elastic Beanstalk
Write-Host "Creating Unix-compatible ZIP for Elastic Beanstalk..." -ForegroundColor Green
...
Write-Host "Creating Unix-compatible ZIP file..." -ForegroundColor Yellow
$ZIP_FILE = "unix-hello-$(Get-Date -Format 'yyyyMMdd-HHmmss').zip"

# Use 7-Zip if available, otherwise use PowerShell with Unix paths
try {
    # Try to use 7-Zip for better Unix compatibility
