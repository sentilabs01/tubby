# Deploy Hello World App to Elastic Beanstalk
Write-Host "Deploying Hello World app to Elastic Beanstalk..." -ForegroundColor Green

# Set environment name
$ENV_NAME = "tubby-hello-$(Get-Date -Format 'yyyyMMdd-HHmmss')"

# Create deployment package
Write-Host "Creating deployment package..." -ForegroundColor Yellow
$DEPLOY_DIR = "deploy-hello"
...
$ZIP_FILE = "hello-world-$(Get-Date -Format 'yyyyMMdd-HHmmss').zip"
...
try {
    ...
    $VERSION_LABEL = "hello-v-$(Get-Date -Format 'yyyyMMdd-HHmmss')"
    ...
    Write-Host "Hello World environment creation initiated!" -ForegroundColor Green
