# Create Elastic Beanstalk Environment with IAM Configuration
Write-Host "Creating Elastic Beanstalk environment with IAM configuration..." -ForegroundColor Green
...
try {
    ...
    Write-Host "Creating new environment with IAM configuration: $ENV_NAME" -ForegroundColor Yellow
